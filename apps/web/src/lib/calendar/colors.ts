...
// step 1: pastel | step 2: mid | step 3: saturated (white text) | step 4: deep (white text)
const ROUND_STEP_CLASSES: Record<string, Record<number, Record<ColorVariant, string>>> = {
  sky: {
    ...
    2: { pill: "bg-sky-200 text-sky-800",    dot: "bg-sky-500",  card: "bg-sky-100 border border-sky-300 text-sky-900"   },
    3: { pill: "bg-sky-400 text-white",      dot: "bg-sky-600",  card: "bg-sky-200 border border-sky-400 text-sky-950"   },
    4: { pill: "bg-sky-600 text-white",      dot: "bg-sky-700",  card: "bg-sky-300 border border-sky-500 text-white"     },
  },
  cyan: {
    1: { pill: "bg-cyan-50 text-cyan-600",   dot: "bg-cyan-300", card: "bg-cyan-50 border border-cyan-100 text-cyan-700"  },
    2: { pill: "bg-cyan-200 text-cyan-800",  dot: "bg-cyan-500", card: "bg-cyan-100 border border-cyan-300 text-cyan-900" },
    3: { pill: "bg-cyan-400 text-white",     dot: "bg-cyan-600", card: "bg-cyan-200 border border-cyan-400 text-cyan-950" },
    4: { pill: "bg-cyan-600 text-white",     dot: "bg-cyan-700", card: "bg-cyan-300 border border-cyan-500 text-white"    },
  },
  teal: {
    1: { pill: "bg-teal-50 text-teal-600",   dot: "bg-teal-300", card: "bg-teal-50 border border-teal-100 text-teal-700"  },
    2: { pill: "bg-teal-200 text-teal-800",  dot: "bg-teal-500", card: "bg-teal-100 border border-teal-300 text-teal-900" },
    3: { pill: "bg-teal-400 text-white",     dot: "bg-teal-600", card: "bg-teal-200 border border-teal-400 text-teal-950" },
    4: { pill: "bg-teal-600 text-white",     dot: "bg-teal-700", card: "bg-teal-300 border border-teal-500 text-white"    },
  },
  indigo: {
    1: { pill: "bg-indigo-50 text-indigo-600",   dot: "bg-indigo-300", card: "bg-indigo-50 border border-indigo-100 text-indigo-700"   },
    2: { pill: "bg-indigo-200 text-indigo-800",  dot: "bg-indigo-500", card: "bg-indigo-100 border border-indigo-300 text-indigo-900"  },
    3: { pill: "bg-indigo-400 text-white",       dot: "bg-indigo-600", card: "bg-indigo-200 border border-indigo-400 text-indigo-950"  },
    4: { pill: "bg-indigo-600 text-white",       dot: "bg-indigo-700", card: "bg-indigo-300 border border-indigo-500 text-white"       },
  },
  green: {
    1: { pill: "bg-green-50 text-green-600",   dot: "bg-green-300", card: "bg-green-50 border border-green-100 text-green-700"   },
    2: { pill: "bg-green-200 text-green-800",  dot: "bg-green-500", card: "bg-green-100 border border-green-300 text-green-900"  },
    3: { pill: "bg-green-400 text-white",      dot: "bg-green-600", card: "bg-green-200 border border-green-400 text-green-950"  },
    4: { pill: "bg-green-600 text-white",      dot: "bg-green-700", card: "bg-green-300 border border-green-500 text-white"      },
  },
  blue: {
    1: { pill: "bg-blue-50 text-blue-600",   dot: "bg-blue-300", card: "bg-blue-50 border border-blue-100 text-blue-700"   },
    2: { pill: "bg-blue-200 text-blue-800",  dot: "bg-blue-500", card: "bg-blue-100 border border-blue-300 text-blue-900"  },
    3: { pill: "bg-blue-400 text-white",     dot: "bg-blue-600", card: "bg-blue-200 border border-blue-400 text-blue-950"  },
    4: { pill: "bg-blue-600 text-white",     dot: "bg-blue-700", card: "bg-blue-300 border border-blue-500 text-white"     },
  },
  violet: {
    1: { pill: "bg-violet-50 text-violet-600",   dot: "bg-violet-300", card: "bg-violet-50 border border-violet-100 text-violet-700"   },
    2: { pill: "bg-violet-200 text-violet-800",  dot: "bg-violet-500", card: "bg-violet-100 border border-violet-300 text-violet-900"  },
    3: { pill: "bg-violet-400 text-white",       dot: "bg-violet-600", card: "bg-violet-200 border border-violet-400 text-violet-950"  },
    4: { pill: "bg-violet-600 text-white",       dot: "bg-violet-700", card: "bg-violet-300 border border-violet-500 text-white"       },
  },
  amber: {
    1: { pill: "bg-amber-50 text-amber-600",   dot: "bg-amber-300", card: "bg-amber-50 border border-amber-100 text-amber-700"   },
    2: { pill: "bg-amber-200 text-amber-800",  dot: "bg-amber-500", card: "bg-amber-100 border border-amber-300 text-amber-900"  },
    3: { pill: "bg-amber-400 text-white",      dot: "bg-amber-600", card: "bg-amber-200 border border-amber-400 text-amber-950"  },
    4: { pill: "bg-amber-600 text-white",      dot: "bg-amber-700", card: "bg-amber-300 border border-amber-500 text-white"      },
  },
  orange: {
    1: { pill: "bg-orange-50 text-orange-600",   dot: "bg-orange-300", card: "bg-orange-50 border border-orange-100 text-orange-700"   },
    2: { pill: "bg-orange-200 text-orange-800",  dot: "bg-orange-500", card: "bg-orange-100 border border-orange-300 text-orange-900"  },
    3: { pill: "bg-orange-400 text-white",       dot: "bg-orange-600", card: "bg-orange-200 border border-orange-400 text-orange-950"  },
    4: { pill: "bg-orange-600 text-white",       dot: "bg-orange-700", card: "bg-orange-300 border border-orange-500 text-white"       },
  },
  fuchsia: {
    1: { pill: "bg-fuchsia-50 text-fuchsia-600",   dot: "bg-fuchsia-300", card: "bg-fuchsia-50 border border-fuchsia-100 text-fuchsia-700"   },
    2: { pill: "bg-fuchsia-200 text-fuchsia-800",  dot: "bg-fuchsia-500", card: "bg-fuchsia-100 border border-fuchsia-300 text-fuchsia-900"  },
    3: { pill: "bg-fuchsia-400 text-white",        dot: "bg-fuchsia-600", card: "bg-fuchsia-200 border border-fuchsia-400 text-fuchsia-950"  },
    4: { pill: "bg-fuchsia-600 text-white",        dot: "bg-fuchsia-700", card: "bg-fuchsia-300 border border-fuchsia-500 text-white"        },
  },
};
